...
#define LTDC_Pixelformat_ARGB8888 LTDC_PIXEL_FORMAT_ARGB8888
#define LTDC_Pixelformat_RGB888 LTDC_PIXEL_FORMAT_RGB888
#define LTDC_Pixelformat_RGB565 LTDC_PIXEL_FORMAT_RGB565
#define LTDC_Pixelformat_ARGB1555 LTDC_PIXEL_FORMAT_ARGB1555
#define LTDC_Pixelformat_ARGB4444 LTDC_PIXEL_FORMAT_ARGB4444
#define LTDC_Pixelformat_L8  LTDC_PIXEL_FORMAT_L8
#define LTDC_Pixelformat_AL44  LTDC_PIXEL_FORMAT_AL44
#define LTDC_Pixelformat_AL88 LTDC_PIXEL_FORMAT_AL88
...
static void _LCD_InitController(int LayerIndex) 
{
	...
	if (LayerIndex < GUI_NUM_LAYERS)
	{
		...
		/* 显存地址 */
		layer_cfg.FBStartAdress = EXT_SDRAM_ADDR;
